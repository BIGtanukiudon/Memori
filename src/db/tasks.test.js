...
import { createTask, deleteTask, listTasks, listTasksByColumn, listTasksByProject, reorderTasks, searchTasksForLog, updateTask, updateTaskColumn, } from "./tasks";
...
describe("createTask", () => {
    ...
    it("タイトル空はエラー", async () => {
        const db = createMockDb();
        await expect(createTask(db, { projectId: "P", columnId: "C", title: "  " })).rejects.toThrow();
    });
});
