...
describe("AllTasksView", () => {
    beforeEach(() => { });
    it("全タスクのタイトルを表示する", () => {
        render(_jsx(AllTasksView, { projects: projects, columns: columns, tasks: tasks }));
    ...
    it("行クリックで onTaskClick が呼ばれる", async () => {
        ...
        render(_jsx(AllTasksView, { projects: projects, columns: columns, tasks: tasks, onTaskClick: onTaskClick }));
