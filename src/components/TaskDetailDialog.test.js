...
function renderDialog(overrides = {}) {
    ...
    return render(_jsx(TaskDetailDialog, { ...props }));
}
const workLog = (over = {}) => ({
    id: "L1",
    taskId: "T1",
...
describe("TaskDetailDialog 作業ログ: 追加と一覧", () => {
    ...
    it("タスクが切り替わると入力欄がクリアされる", async () => {
        ...
        rerender(_jsx(TaskDetailDialog, { open: true, task: { ...baseTask, id: "T2" }, onSave: () => { }, onDelete: () => { }, onClose: () => { }, workLogs: [], onAddWorkLog: () => { }, onUpdateWorkLog: () => { }, onDeleteWorkLog: () => { } }));
