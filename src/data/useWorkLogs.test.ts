...
vi.mock("@/db/workLogs", () => ({
  listWorkLogsByTask: (...a: unknown[]) => listWorkLogsByTask(...a),
}));
vi.mock("./workLogActions", () => ({
  createWorkLogAction: (...a: unknown[]) => createWorkLogAction(...a),
  updateWorkLogAction: (...a: unknown[]) => updateWorkLogAction(...a),
  deleteWorkLogAction: (...a: unknown[]) => deleteWorkLogAction(...a),
}));
