...
import { createProjectAction, renameProjectAction, deleteProjectAction, countTasksInProject, reorderProjectsAction, setDoneColumnAction, } from "./projectActions";
beforeEach(() => {
...
describe("setDoneColumnAction", () => {
    it("DBに完了列IDを設定し、storeのprojectを更新する", async () => {
        ...
        expect(db.execute).toHaveBeenCalledWith(expect.stringMatching(/UPDATE projects SET done_column_id/), ["C_DONE", "P1"]);
